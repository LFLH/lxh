...
# 表 4活动文件表(活动id,文件id)
AD = db.Table('ad', db.Column('activityid', db.Integer, db.ForeignKey('activity.id')),
              db.Column('dataid', db.Integer, db.ForeignKey('data.id')))

# 表 5活动报名表(活动id,用户id，状态,ip地址)
AU = db.Table('au', db.Column('activityid', db.Integer, db.ForeignKey('activity.id')),
              db.Column('userid', db.Integer, db.ForeignKey('user.id')), db.Column('type', db.Integer),
...
UDCD = db.Table('dcud', db.Column('udcid', db.Integer, db.ForeignKey('udeclare.id')),
                db.Column('dataid', db.Integer, db.ForeignKey('data.id')))
...
DUDC = db.Table('dudc', db.Column('declareid', db.Integer, db.ForeignKey('declare.id')),
                db.Column('udcid', db.Integer, db.ForeignKey('udeclare.id')))
...
UTD = db.Table('utd', db.Column('utid', db.Integer, db.ForeignKey('utrain.id')),
               db.Column('dataid', db.Integer, db.ForeignKey('data.id')))
...
TUT = db.Table('tut', db.Column('trainid', db.Integer, db.ForeignKey('train.id')),
               db.Column('utid', db.Integer, db.ForeignKey('utrain.id')))
...
RD = db.Table('rd', db.Column('rid', db.Integer, db.ForeignKey('record.id')),
              db.Column('dataid', db.Integer, db.ForeignKey('data.id')))
