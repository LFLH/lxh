...
def detailactivity():
    ...
    for data in datas:
        ...
        item.append(dataa)
    da = {'username': user.username, 'name': activity.name, 'begintime': activity.begintime,
          'endtime': activity.endtime, 'cxtime': activity.cxtime, 'uptime': activity.uptime, 'main': activity.main,
          'type': activity.type, 'datas': item}
